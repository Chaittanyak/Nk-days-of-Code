...
lblDisplay=Label(calc, text="NkC Scientific Calculator", font=('arial', 30, 'bold'), justify =CENTER)
lblDisplay.grid(row=0, column=4, columnspan=4)

lblDisplay=Label(calc, text="NkC Calci", font=('arial', 30, 'bold'), justify =CENTER)
